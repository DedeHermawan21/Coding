...
void tambah (Node **root, int databaru)
{
	...
	//jika data yang akan dimasukan lebih kecil daripada elemen root, maka akan diletakan di node sebelah kiri.
	else if (databaru<(*root)->data)
	tambah (&(*root)->kiri, databaru);
	//jika data yang akan dimasukan lebih besar daripada elemen root, maka akan diletakan di node sebelah kanan
	else if(databaru>(*root)->data)
	tambah (&(*root)->kanan, databaru);
	//jika saat dicek data yang akan dimasukan memiliki nilai yang sama dengan data pada root
	else if (databaru == (*root)->data)
